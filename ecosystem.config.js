module.exports = {
    apps: [{
      ...
      node_args: "--max-old-space-size=16384",//increases the heap space to be used to avoid heapspace limitation.
      env_development: {
  ...
  Take A Good Look that config file for nodemon.json is json and i can't write any comment in there, it's not allowed. hence i am also mentioning the code for nodemon in there🧑🏼sorry. Below is the script if you want to use the nodemon for the server. you are going to use 👉🏼npm run start:dev and 👉🏼npm run stop or ctrl+c.
  "scripts": {
